...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signin" method="POST" action="/backend/back-register.php">
        <img class="mb-4" src="/docs/4.5/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">
        
        <h1 class="h3 mb-3 font-weight-normal">Please Sign Up</h1>
        
        <label for="inputEmail" class="sr-only">Nama Lengkap</label>
        <input name="fullname" type="text" id="inputEmail" class="form-control" placeholder="Nama Lengkap" required autofocus>
